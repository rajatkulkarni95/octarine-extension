...
interface TemplateSelectorProps {
  ...
  onTemplateChange: (templateId: "default" | "github-pr" | "github-issues") => void;
}

const TEMPLATE_NAMES: Record<"default" | "github-pr" | "github-issues", string> = {
  default: "Default",
  "github-pr": "GitHub PR",
        ...
        <Select.Portal>
          <Select.Content className="overflow-hidden bg-primary border border-primary rounded shadow-lg">
            <Select.Viewport className="p-1">
              {(Object.keys(TEMPLATE_NAMES) as Array<"default" | "github-pr" | "github-issues">).map((templateId) => (
                <Select.Item
                  key={templateId}
                  value={templateId}
